...
public class CreationEntrepriseDTO {
    ...
    public CreationEntrepriseDTO(int id, String nom, List<Integer> idEmployes,
                                 String secteur, String localisation, String url, String avantages,
                                 String description, int nbEmployes, double noteSatisfaction,
                                 double scoreRse, String chiffreAffaires, int dateCreation,
                                 int nbAgences, String paysPresents, String siteWeb,
                                 String lienPostuler, Taille taille) {
        this.id = id;
        this.nom = nom;
